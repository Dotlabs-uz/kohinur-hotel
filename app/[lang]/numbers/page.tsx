    ...
    return (
        <div>
            <section className="relative h-[350px] max-xl:h-[600px] max-lg:h-[500px] max-md:h-[430px] max-sm:h-[200px] flex flex-col gap-0 items-center justify-center text-white">
                ...
                <h1
                    data-aos="zoom-in"
                    className="text-7xl max-md:text-6xl max-sm:text-4xl leading-[68px] max-xl:text-[130px] max-xl:leading-[100px] max-lg:text-[110px] max-md:text-[80px] max-sm:text-[46px] max-sm:leading-[40px] font-cormorant text-center"
                >
