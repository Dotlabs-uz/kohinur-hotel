    ...
    return (
        <div>
            <section className="relative h-[400px] max-lg:h-[300px] max-sm:h-[200px] flex flex-col items-center justify-center text-white">
                ...
                <h1
                    data-aos="zoom-in"
                    className="text-7xl max-lg:text-6xl max-md:text-5xl max-sm:text-4xl font-cormorant text-center max-w-[730px] max-lg:max-w-[630px] max-sm:max-w-[330px]"
                >
                    Отзывы наших гостей
                </h1>
                <p
                    data-aos="zoom-in"
                    data-aos-delay="500"
                    className="mt-3 max-w-xl max-md:max-w-xs max-sm:max-w-[280px] text-center text-base max-md:text-sm max-sm:text-xs"
                >
            ...
            <section className="max-w-4xl max-xl:max-w-3xl max-lg:max-w-2xl max-md:max-w-xl max-sm:w-[80%] m-auto">
                {[1, 2].map((item) => (
                    <div
                        key={item}
                        className="mt-10 max-sm:mt-5 pb-11 border-b-2 border-[#686868]"
                    >
                        ...
                        <div className="flex items-center gap-2 mt-10 max-sm:mt-4">
                            ...
                            />
                            <p className="text-xl max-lg:text-lg max-md:text-base max-sm:text-xs font-medium">
                                4.7 Звезд(-ы)
                            </p>
                        </div>
