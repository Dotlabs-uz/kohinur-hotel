                    ...
                    {filteredArr.map((item:any) => (
                        ...
                        key={item}>
                            <Image
                                ...
                                className="w-full"
                            />
                            <h4 className="text-5xl max-lg:text-4xl max-md:2xl max-sm:text-lg font-bold font-cormorant mt-8 max-md:mt-6 max-sm:mt-3">
                                {item.title}
                            </h4>
                            <p className="text-2xl max-lg:text-xl max-md:text-lg max-sm:text-base mt-3 max-md:mt-2 max-sm:mt-1">
                                {item.info}
                            </p>
                        </div>
                    ))}
